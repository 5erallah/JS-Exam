...
function closeSideNav() {
  let boxWidth = $(".side-bar-menu .nav-bar").outerWidth();
  $(".side-bar-menu").animate(
    {
      left: -boxWidth,
    },
...
async function getCategories() {
  DataRow.innerHTML = "";
  $(".inner-waiting-screen").fadeIn(300);
  ...
  dispCategories(response.categories);
  $(".inner-waiting-screen").fadeOut(300);
}

function dispCategories(arr) {
  let Box = "";
...
async function getIngredients() {
  ...
  dispIngredients(respone.meals.slice(0, 20));
  $(".inner-waiting-screen").fadeOut(300);
}
...
async function getMealDetails(mealID) {
  ...
  dispMealDetails(respone.meals[0]);
  $(".inner-waiting-screen").fadeOut(300);
}

function dispMealDetails(meal) {
  searchContainer.innerHTML = "";
...
async function searchByName(term) {
  ...
  response.meals ? dispMeals(response.meals) : dispMeals([]);
  $(".inner-waiting-screen").fadeOut(300);
}
